bootstrap_Drop <- function(Y,X1,X2,param="multilogit",Mu,Si,Be,Ga,B=100){
...
# preliminaries
  ...
  for (b in 1:B) {
    ...
    out <- lmcovlatent.contMISS(Y=Yb,X1=X1b,X2=X2b,k=k,param=param,output=TRUE,
                                start=2,Mu=Mu,Si=Si,Be=Be,Ga=Ga)  
